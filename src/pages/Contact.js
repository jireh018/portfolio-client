    ...
    return (
        <div className='container mx-auto flex flex-col-reverse lg:flex-row py-5 lg:py-10 lg:mt-10'>
            <div className='w-full lg:w-1/2'>
                <section class="bg-white dark:bg-gray-900 border border-gray-300 rounded">
                    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md ">
                        ...
                        <form action="#" class="space-y-8">
                            ...
                            <button type="submit" class="bg-cyan-500 py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                Send message</button>
                        </form>
                    </div>
                </section>
