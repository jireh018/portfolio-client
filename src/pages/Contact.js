            ...
            <div className='w-full lg:w-1/2'>
                <section className="bg-white dark:bg-gray-900 border border-gray-300 rounded">
                    <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md ">
                        ...
                        <form action="https://public.herotofu.com/v1/b9839e70-e9d5-11ed-b2e2-c10354b56774" method="POST" accept-charset="UTF-8" className="space-y-8">
                            <div>
                            ...
                            <div aria-hidden="true">
                                <input type="text" value=' ' name="_gotcha" autocomplete="off" />
                            </div>
                        </form>
                    </div>
                </section>
